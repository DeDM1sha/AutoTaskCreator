//  ласс базы данных всех клиентов и заказов, имеющихс€ в базе
...
class Class_Statistics {
    ...
    private:
        ...
        unsigned short int TotalNumber_Completed_LabWorks; // общее кол-во выполненных лабораторных работ [LabWorks]
        unsigned short int TotalNumber_Completed_CourseWorks; // общее кол-во выполненных курсовых работ [CourseWork]
        unsigned short int TotalNumber_Completed_DiplomaWorks; // общее кол-во выполенных дипломных работ [Diploma]

        unsigned short int TotalNumber_Technology_C; // общее количество выполненных задач на [—и]
        unsigned short int TotalNumber_Technology_CPlusPlus; // общее количество выполненных задач на [C++]
        unsigned short int TotalNumber_Technology_Another; // общее количество выполненных задач по другим направлени€м (помощь на экзаменах, ответы на вопросы и т.д.)
        ...
        unsigned short int TotalNumber_IDE_NoneIDE; // общее количество выполненных задач дл€ [Another] заказов
    ...
    public:
        ...
        Class_Statistics (const Class_Settings& Settings) {
            ...
            this->TotalNumber_Completed_LabWorks = 0;
            this->TotalNumber_Completed_CourseWorks = 0;
            this->TotalNumber_Completed_DiplomaWorks = 0;
    ...
    //////////////////////////////////////////////
		...
		} // геттер дл€ TotalNumber_ClientsInDB_Count

		const unsigned short int getTotalNumber_CompletedTasks_Count (void) const {

			return this->TotalNumber_CompletedTasks_Count;

		} // геттер дл€ TotalNumber_CompletedTasks_Count

		const unsigned short int getTotalNumber_Completed_LabWorks (void) const {

			return this->TotalNumber_Completed_LabWorks;

		} // геттер дл€ TotalNumber_Completed_LabWorks

		const unsigned short int getTotalNumber_Completed_CourseWorks (void) const {

			return this->TotalNumber_Completed_CourseWorks;

		} // геттер дл€ TotalNumber_Completed_CourseWorks

		const unsigned short int getTotalNumber_Completed_DiplomaWorks (void) const {

			return this->TotalNumber_Completed_DiplomaWorks;

		} // геттер дл€ TotalNumber_Completed_DiplomaWorks
    ...
    //////////////////////////////////////////////
        ...
        } // геттер дл€ TotalNumber_Clients_InBanList_Count
        ...
        } // геттер дл€ TotalNumber_Workers_InBanList_Count
                     ...
                     std::ifstream Read (LogPath.c_str ());
                        ...
                        while (Read >> Str) {
                            ...
                            if (Str == Settings.getSaveTag_Field_Technology()) {
                                ...
                                Read >> Str; // считывание значени€ дл€ пол€ [Technology]
                            ...
                            } // проверка пол€ Technology

                            else if (Str == Settings.getSaveTag_Field_IDE ()) {

                                Read >> Str; // считывание символа [=]
                                Read >> Str; // считывание значени€ дл€ пол€ [IDE]
                                ...
                                Read >> Str; // считывание символа [=]
                                Read >> Str; // считывание значени€ дл€ пол€ [OS]
                            ...
                            else if (Str == Settings.getSaveTag_Field_TypeWork ()) {

                                Read >> Str; // считывание символа [=]
                                Read >> Str; // считывание значени€ дл€ пол€ [TypeWork]

                                    if (Str == Settings.getTypeWork_Name_LabWork ())
                                        this->TotalNumber_Completed_LabWorks++;

                                    else if (Str == Settings.getTypeWork_Name_CourseWork ())
                                        this->TotalNumber_Completed_CourseWorks++;

                                    else if (Str == Settings.getTypeWork_Name_Diploma ())
                                        this->TotalNumber_Completed_DiplomaWorks++;

                            } // проверка пол€ TypeWork
